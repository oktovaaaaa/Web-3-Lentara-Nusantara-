...
class TribeFoodRecommendationSeeder extends Seeder
{
    public function run(): void
    {
            ...
            [
                ...
                'items' => [
                    ...
                    [
                        ...
                        'category' => 'main_course',
                        'image_url' => 'https://images.unsplash.com/photo-1562967914-608f82629710?auto=format&fit=crop&q=80&w=800',
        ...
        foreach ($foodsData as $data) {
            ...
            foreach ($data['items'] as $it) {
                ...
                $finalItems[] = [
                    ...
                    'image_url' => $it['image_url'] ?? 'https://images.unsplash.com/photo-1540189549336-e6e99c3679fe?auto=format&fit=crop&q=80&w=800',
                    'sources' => $sources,
        ...
        $this->command->info('Rekomendasi makanan tradisional untuk 18 suku berhasil disemai dengan foto spesifik!');
    }
}
