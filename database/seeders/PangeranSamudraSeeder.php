    ...
    public function run(): void
    {
        ...
        $steps = [
            ...
            [
                ...
                'background_path'=> $bg('bg_kerajaan.png'),
                'character_path' => $bg('Pengenalan Kerajaan Daha/Langkah 2_ Ambisi Pangeran Tumenggung.png'),
                'animation_type' => 'none',
                'options'        => null,
            ],
            [
                ...
                'dialogue_text'  => 'Pamanku, Pangeran Tumenggung, telah merebut takhta Daha and mengincar nyawaku. Apa yang harus aku lakukan untuk menyelamatkan takhta Daha yang sah?',
                'background_path'=> $bg('bg_kerajaan.png'),
                'character_path' => $bg('Pengenalan Kerajaan Daha/Langkah 3_ Dilema Sang Pewaris.png'),
                'animation_type' => 'none',
                'options'        => [
            ...
            [
                ...
                'background_path'=> $bg('bg_sungai.png'),
                'character_path' => $bg('Pengenalan Kerajaan Daha/Langkah 5_ Penyamaran Pertama.png'),
                'animation_type' => 'fade',
                'options'        => null,
            ],
            [
            ...
            [
                ...
                'background_path'=> $bg('bg_muara.png'),
                'character_path' => $bg('Pengenalan Kerajaan Daha/Langkah 8_ Pertemuan dengan Patih Masih.png'),
                'animation_type' => 'fade',
                'options'        => null,
            ],
            [
                ...
                'background_path'=> $bg('bg_muara.png'),
                'character_path' => $bg('Pengenalan Kerajaan Daha/Langkah 9_ Mengungkap Kebenaran.png'),
                'animation_type' => 'none',
                'options'        => [
            ...
            [
                ...
                'background_path'=> $bg('bg_muara.png'),
                'character_path' => $bg('Pengenalan Kerajaan Daha/Langkah 10_ Sumpah Setia Patih Masih.png'),
                'animation_type' => 'zoom',
                'options'        => null,
            ],
            [
            ...
            [
                ...
                'background_path'=> $bg('bg_konflik.png'),
                'character_path' => $bg('Pengenalan Kerajaan Daha/Langkah 12 dan 13_ Menghadapi Pasukan Utama.png'),
                'animation_type' => 'shake',
                'options'        => [
            ...
            [
                'order'          => 14,
                'character_name' => 'Pangeran Samudra',
                'dialogue_text'  => 'Terima kasih rakyatku! Bersama Patih Masih dan persatuan Banjar-Dayak, kita akan menegakkan keadilan dan mendirikan Kesultanan Banjar yang berdaulat!',
                'background_path'=> $bg('bg_kerajaan.png'),
                'character_path' => $bg('Pengenalan Kerajaan Daha/Langkah 14_ Sumpah Keadilan Raja Samudra.png'),
                'animation_type' => 'fade',
                'options'        => null,
            ],
        ];
