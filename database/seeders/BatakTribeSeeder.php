...
class BatakTribeSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $destinations = [
            ...
            [
                'name' => 'Rm Tona Masakan Khas Batak',
                'location' => 'Jalan Sisingamangaraja, Tampubolon, Balige, Toba',
                'description' => 'Rumah makan tradisional khas Batak Toba yang menyajikan hidangan arsik, manuk pinadar, naniura, dan menu tradisional otentik lainnya.',
            ...
            [
                'name' => 'RM Khas Batak Dainang',
                'location' => 'Jalan Sisingamangaraja, Tampubolon, Balige, Toba',
                'description' => 'Rumah makan tradisional menyajikan masakan Batak lezat seperti BPK, saksang, dan ikan mas arsik dengan bumbu andaliman.',
                'image_url' => 'https://images.unsplash.com/photo-1540189549336-e6e99c3679fe?auto=format&fit=crop&q=80&w=800',
                'rating' => 4.6,
                'sort_order' => 4,
                'is_active' => true,
            ...
            [
                'name' => 'RM. Sonang Pakpahan Khas Batak',
                'location' => 'Jalan Sisingamangaraja, Tampubolon, Balige, Toba',
                'description' => 'RM tradisional Batak terkenal dengan olahan sup daging, panggang, dan sayur singkong tumbuk bumbu andaliman.',
                'image_url' => 'https://images.unsplash.com/photo-1540189549336-e6e99c3679fe?auto=format&fit=crop&q=80&w=800',
                'rating' => 4.3,
                'sort_order' => 5,
                'is_active' => true,
            ...
            [
                'name' => 'RM. Horas Khas Batak',
                'location' => 'Jalan Sisingamangaraja, Laguboti, Toba',
                'description' => 'Pusat kuliner batak di Laguboti menyajikan aneka hidangan panggang tradisional Batak dengan bumbu andaliman pedas getir.',
                'image_url' => 'https://images.unsplash.com/photo-1540189549336-e6e99c3679fe?auto=format&fit=crop&q=80&w=800',
                'rating' => 4.4,
                'sort_order' => 6,
                'is_active' => true,
            ...
            [
                'name' => 'Resto Tiger Khas Batak Laguboti',
                'location' => 'Jalan Sisingamangaraja, Laguboti, Toba',
                'description' => 'Restoran keluarga menyajikan menu sate babi, babi panggang karo (BPK), sop, dan ayam panggang khas Batak.',
                'image_url' => 'https://images.unsplash.com/photo-1540189549336-e6e99c3679fe?auto=format&fit=crop&q=80&w=800',
                'rating' => 4.9,
                'sort_order' => 7,
                'is_active' => true,
                ...
                'longitude' => 99.05728,
                'pano_embed_url' => null,
                'pano_maps_url' => 'https://maps.app.goo.gl/uXj9C5w95X9Z5w9Y8',
                'pano_label' => null,
            ]
        ];
